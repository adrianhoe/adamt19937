...
--------------------------------------------------------------------------------
package AdaMT19937.Integer_Utilities is
   
   function Random_Long_Integer  (G : in Generator) return Long_Integer;
   function Random_Short_Integer (G : in Generator) return Short_Integer;
   function Random_4_Digit       (G : in Generator) return Short_Integer;
